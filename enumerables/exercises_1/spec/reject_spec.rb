RSpec.describe 'reject' do
  ...
  it 'removes words longer than three letters' do
  ...
  it 'removes numbers' do
    ...
    not_numbers = elements.reject do |element|
      element.class == Integer || element.class == Float
    end
  ...
  it 'removes floats' do
    ...
    not_floats = elements.reject do |element|
      element.class == Float
    end
